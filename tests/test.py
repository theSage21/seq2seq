from seq2seq import SimpleSeq2Seq, Seq2Seq, AttentionSeq2Seq, PointerSeq2Seq
import numpy as np
...
def test_AttentionSeq2Seq():
    ...
    models = []
    models += [PointerSeq2Seq(output_dim=output_dim, hidden_dim=hidden_dim, output_length=output_length, input_shape=(input_length, input_dim))]
